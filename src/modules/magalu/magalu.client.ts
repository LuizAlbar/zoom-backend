      ...
      const mockDb: MagaluProductNode[] = [
        {
          ...
          price: 4899.90,
          imageUrl: 'https://images.unsplash.com/photo-1496181130204-755241524eab?w=400&auto=format&fit=crop&q=60',
          productLink: `https://www.magazineluiza.com.br/busca/${encodeURIComponent(keyword)}`,
        },
        {
          sku: 'MGL-5432',
        ...
        },
        {
          ...
          price: 189.90,
          imageUrl: 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?w=400&auto=format&fit=crop&q=60',
          productLink: `https://www.magazineluiza.com.br/busca/${encodeURIComponent(keyword)}`,
        }
      ];
